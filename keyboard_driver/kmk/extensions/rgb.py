...
def hsv_to_rgb(hue, sat, val):
    """Converts HSV values, and returns a tuple of RGB values :param hue:
...
def hsv_to_rgbw(hue, sat, val):
    """Converts HSV values, and returns a tuple of RGBW values :param hue:
...
class RGB(Extension):
    ...
    def during_bootup(self, sandbox):
        ...
        self._task = create_task(
            self.animate, period_ms=(1000 // self.refresh_rate)
        )
    ...
    def set_hsv(self, hue, sat, val, index):
        """Takes HSV values and displays it on a single LED/Neopixel :param
        hue:
    ...
    def set_hsv_fill(self, hue, sat, val):
        """Takes HSV values and displays it on all LEDs/Neopixels :param hue:
    ...
    def set_rgb(self, rgb, index):
        """Takes an RGB or RGBW and displays it on a single LED/Neopixel :param
        rgb: RGB or RGBW :param index: Index of LED/Pixel."""
    ...
    def set_rgb_fill(self, rgb):
        """Takes an RGB or RGBW and displays it on all LEDs/Neopixels :param
        rgb: RGB or RGBW."""
        for pixels in self.pixels:
            pixels.fill(rgb)
