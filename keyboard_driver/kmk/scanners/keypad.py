...
class KeypadScanner(Scanner):
    ...
    def scan_for_changes(self):
        ...
        The key report is a byte array with contents [row, col, True if
        pressed else False]
        """
...
class KeysScanner(KeypadScanner):
    ...
    :param pins: An array of arrays of CircuitPython Pin objects, such
        that pins[r][c] is the pin for row r, column c.
    """
