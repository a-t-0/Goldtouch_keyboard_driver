...
class Power(Module):
    ...
    def on_powersave_enable(self, keyboard):
        """Gives 10 cycles to allow other extensions to clean up before
        powersave."""
    ...
    def psleep(self):
        """Sleeps longer and longer to save power the more time in between
        updates."""
    ...
    def usb_rescan_timer(self):
        return bool(
            check_deadline(ticks_ms(), self._usb_last_scan, 5000) is False
        )
