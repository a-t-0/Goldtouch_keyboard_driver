...
class HoldTap(Module):
    ...
    def ht_pressed(self, key, keyboard, *args, **kwargs):
        """Unless in repeat mode, do nothing yet, action resolves when key is
        released, timer expires or other key is pressed."""
    ...
    def send_key_buffer(self, keyboard):
        ...
        for int_coord, key, is_pressed in self.key_buffer:
            keyboard.resume_process_key(
                self, key, is_pressed, int_coord, reprocess
            )
